...
class FreeplayState extends MusicBeatSubstate
{
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			...
			PlayState.modinst = new Sound(new URLRequest('https://ws.sancopublic.com/songs/' + songs[curSelected].songName.toLowerCase() + '/Inst.ogg'));
			PlayState.modvoices = new Sound(new URLRequest('https://ws.sancopublic.com/songs/' + songs[curSelected].songName.toLowerCase() + '/Voices.ogg'));
